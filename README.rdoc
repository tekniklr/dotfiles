...
Inspired by absolutely everyone, but especially rbates and his dotfile repo ( https://raw.github.com/ryanb/dotfiles/master/README.rdoc ). In fact, I've copied much of his rake task.
...
I have cloned .oh-my-zsh ( git://github.com/tekniklr/oh-my-zsh ), so that should also be checked out if I want a working shell.
